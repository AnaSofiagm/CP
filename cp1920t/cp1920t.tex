...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\mathrel{=}\underline{\Conid{Nothing}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Varid{x}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{splay}\;\Varid{l}\;\Varid{t}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Conid{Leaf}}{\Varid{f}}{}\<[E]%
\\
\>[21]{}\hsindent{6}{}\<[27]%
\>[27]{}\Varid{f}\;(\Varid{e},\Varid{d})\mathrel{=}\alt{\Varid{f1}}{\Varid{f2}}\;(\Varid{outList}\;\Varid{b})\;\mathbf{where}{}\<[E]%
\\
\>[27]{}\hsindent{2}{}\<[29]%
\>[29]{}\Varid{f1}\mathrel{=}\underline{(\Conid{Fork}\;(\Varid{e},\Varid{d}))}{}\<[E]%
\\
\>[27]{}\hsindent{2}{}\<[29]%
\>[29]{}\Varid{f2}\mathrel{=}(\uncurry{\Varid{navLTree}}\comp (\Varid{\Conid{Cp}.cond}\;(\p1)\;\conj{\underline{\Varid{e}}}{\p2}\;\conj{\underline{\Varid{d}}}{\p2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
